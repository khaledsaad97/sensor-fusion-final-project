...
class Track:
    ...
    def __init__(self, meas, id):
        ...
        ############
        pos_sens = np.ones((3, 1)) # homogeneous coordinates
        pos_sens = meas.z[0:3] 
...
class Trackmanagement:
    ...
    def manage_tracks(self, unassigned_tracks, unassigned_meas, meas_list):  
        ...
        #   (check params.py for parameters that might be helpful, 
        #   but feel free to define your own parameters)
        ############
        ...
        for track in self.track_list : 
            if track.state == "confirmed":
                if track.score < params.delete_threshold or track.P[1,1] >= params.max_P or track.P[2,2] >= params.max_P :
                    self.delete_track(track)
            else:   # tentative or initialized
                if track.P[1,1] >= params.max_P or track.P[2,2] >= params.max_P :
                    self.delete_track(track)
        ############
        # END student code
        ############ 
